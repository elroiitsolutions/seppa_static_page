...
const pageData: PackagingPageData = {
  title: "Soft Drink Line Machines",
  breadcrumbName: "Soft Drink Line Machines",
  rootBreadcrumbName: "Services",
  rootBreadcrumbPath: "/services",
  overviewTitle: "Premium Solutions for Soft Drink Line Machines",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Soft Drink Line Machines. Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Soft Drink Line Machines Systems",
