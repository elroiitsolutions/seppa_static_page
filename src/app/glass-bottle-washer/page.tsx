...
const pageData: PackagingPageData = {
  title: "Glass Bottle Washer",
  breadcrumbName: "Glass Bottle Washer",
  rootBreadcrumbName: "Equipments",
  rootBreadcrumbPath: "#",
  overviewTitle: "Premium Solutions for Glass Bottle Washer",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Glass Bottle Washer. Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Glass Bottle Washer Systems",
