...
const pageData: PackagingPageData = {
  title: "Mineral Water Line Machines",
  breadcrumbName: "Mineral Water Line Machines",
  rootBreadcrumbName: "Liquid",
  rootBreadcrumbPath: "/liquid",
  overviewTitle: "Premium Solutions for Mineral Water Line Machines",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Mineral Water Line Machines. Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Mineral Water Line Machines Systems",
