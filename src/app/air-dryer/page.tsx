...
const pageData: PackagingPageData = {
  title: "Air Dryer",
  breadcrumbName: "Air Dryer",
  rootBreadcrumbName: "Equipments",
  rootBreadcrumbPath: "#",
  overviewTitle: "Premium Solutions for Air Dryer",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Air Dryer. Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Air Dryer Systems",
