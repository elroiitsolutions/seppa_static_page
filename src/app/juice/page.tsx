...
const pageData: PackagingPageData = {
  ...
  overviewsubDescription: [
    ...
    <strong key="h1" className="text-black font-bold block mb-3 mt-8 text-xl">High Pressure Pasteurization Quietly Rewriting the Rules</strong>,
    ...
    <p key="p1" className="text-base md:text-lg text-gray-600 leading-relaxed indent-8 md:indent-12"><strong className="text-black font-bold">1. Taste that actually survives the process.</strong> HPP uses pressurized cold water nothing else. No heat, no irradiation, no chemicals. The result is a juice that tastes like it was pressed an hour ago, even weeks after bottling. Once shoppers have tasted the difference, they start hunting these products down on the shelf.</p>,
    <p key="p2" className="text-base md:text-lg text-gray-600 leading-relaxed indent-8 md:indent-12"><strong className="text-black font-bold">2. Real food safety.</strong> Listeria and salmonella headlines have made consumers genuinely cautious. HPP inactivates microorganisms using water pressure alone, with no preservatives required. That's a powerful claim on a label, and it's an honest one.</p>,
    <p key="p3" className="text-base md:text-lg text-gray-600 leading-relaxed indent-8 md:indent-12"><strong className="text-black font-bold">3. Longer shelf life with less waste.</strong> Retailers love HPP because spoilage drops sharply. Some vacuum packed fresh products now hold their quality for 30 days, which changes the entire economics of distribution.</p>,
    <p key="p4" className="text-base md:text-lg text-gray-600 leading-relaxed indent-8 md:indent-12"><strong className="text-black font-bold">4. Sixty years of installed experience.</strong> Seppa has commissioned more HPP systems than most of its competitors combined. In a field this specialized, that history matters it shows up in the small engineering decisions that keep a Juice Processing Plant running smoothly year after year.</p>
  ],
