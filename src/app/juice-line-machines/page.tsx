...
const pageData: PackagingPageData = {
  title: "Juice Line Machines",
  breadcrumbName: "Juice Line Machines",
  rootBreadcrumbName: "Services",
  rootBreadcrumbPath: "/services",
  overviewTitle: "Premium Solutions for Juice Line Machines",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Juice Line Machines. Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Juice Line Machines Systems",
