...
const pageData: PackagingPageData = {
  ...
  breadcrumbName: "Labeling Machines",
  rootBreadcrumbName: "Equipments",
  rootBreadcrumbPath: "#",
  overviewTitle: "Premium Solutions for Labeling Machines",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Labeling Machines. Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Labeling Machines Systems",
