...
const pageData: PackagingPageData = {
  ...
  breadcrumbName: "Capping Machines",
  rootBreadcrumbName: "Equipments",
  rootBreadcrumbPath: "#",
  overviewTitle: "Premium Solutions for Capping Machines",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Capping Machines. Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Capping Machines Systems",
