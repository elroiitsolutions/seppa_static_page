...
export default async function LocalizedServiceLineImprovementPage({ params }: Props) {
  ...
  const relatedBlogs = await getRelatedBlogs('/services/line-improvement', locale);
