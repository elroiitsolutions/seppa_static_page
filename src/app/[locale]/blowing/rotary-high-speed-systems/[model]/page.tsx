...
const models = ['ssb-r6', 'ssb-r8', 'ssb-r10', 'ssb-r12', 'ssb-r16'];
...
export default async function RotarySsbRModelPage({ params }: PageProps) {
  const { locale, model } = await params;
  setRequestLocale(locale);

  // Normalize model param to namespace e.g. "ssb-r6" -> "ssbr6"
  ...
  const relatedBlogs = await getRelatedBlogs('/blowing/rotary-high-speed-systems/[model]', locale);
