...
const pageData: PackagingPageData = {
  title: "Conveyors",
  breadcrumbName: "Conveyors",
  rootBreadcrumbName: "Equipments",
  rootBreadcrumbPath: "#",
  overviewTitle: "Premium Solutions for Conveyors",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Conveyors. Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Conveyors Systems",
