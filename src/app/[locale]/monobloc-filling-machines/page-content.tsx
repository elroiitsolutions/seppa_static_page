...
const pageData: PackagingPageData = {
  title: "Monobloc Filling Machines",
  breadcrumbName: "Monobloc Filling Machines",
  rootBreadcrumbName: "Equipments",
  rootBreadcrumbPath: "#",
  overviewTitle: "Premium Solutions for Monobloc Filling Machines",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Monobloc Filling Machines. Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Monobloc Filling Machines Systems",
