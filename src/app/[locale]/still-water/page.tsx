...
export default async function StillWaterPage({ params }: PageProps) {
  const { locale } = await params;
  setRequestLocale(locale);
  const t = await getTranslations({ locale, namespace: 'stillwater' });
  ...
  const relatedBlogs = await getRelatedBlogs('/still-water', locale);
