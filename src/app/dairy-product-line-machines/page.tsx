...
const pageData: PackagingPageData = {
  title: "Dairy Product Line Machines",
  breadcrumbName: "Dairy Product Line Machines",
  rootBreadcrumbName: "Services",
  rootBreadcrumbPath: "/services",
  overviewTitle: "Premium Solutions for Dairy Product Line Machines",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Dairy Product Line Machines. Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Dairy Product Line Machines Systems",
