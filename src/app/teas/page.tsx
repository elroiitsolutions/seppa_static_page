...
const pageData: PackagingPageData = {
  title: "Teas (JNSDIT)",
  breadcrumbName: "Teas (JNSDIT)",
  rootBreadcrumbName: "Liquid",
  rootBreadcrumbPath: "/liquid",
  overviewTitle: "Premium Solutions for Teas (JNSDIT)",
  overviewDescription: "We provide comprehensive, high-quality, and state-of-the-art solutions tailored for Teas (JNSDIT). Our systems are designed for maximum efficiency, precision, and durability, ensuring your production lines operate flawlessly.",
  overviewBenefits: [
  ...
  featuresTitle: "Key Features of Our Teas (JNSDIT) Systems",
