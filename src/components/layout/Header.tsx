...
const Header: React.FC = () => {
  ...
  return (
    <header className={headerClass}>
      <div className="container mx-60 px-4 flex justify-between items-center">
        {/* Logo */}
        ...
        <nav className="hidden lg:flex items-center space-x-8">
          ...
          <div className='relative group'>
            ...
            <div className="absolute top-full -left-64 mt-2 w-[900px] bg-seppa-red text-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-50 p-3 grid grid-rows-6 grid-flow-col">
              {/* Column 1 */}
