...
const HomeFAQs = () => {
  return (
    <section 
      className="py-24 bg-white overflow-hidden bg-repeat"
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          >
            ...
            <AnimatedHeading 
              ...
              elementType="h2" 
              className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-dark leading-tight mb-10" 
            />
            
            <motion.div variants={fadeInUp} className="flex items-center gap-3 group cursor-pointer w-max">
              <Link href="/faqs" className="inline-flex bg-[#273051] text-white px-8 py-[18px] rounded-full font-bold text-lg group-hover:bg-seppa-red transition duration-300 tracking-wide">
                View all FAQ's
              </Link>
              <Link href="/faqs" className="w-[60px] h-[60px] bg-seppa-red flex items-center justify-center text-white rounded-full group-hover:bg-[#273051] transition duration-300 shadow-md">
