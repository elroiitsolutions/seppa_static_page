        ...
        <section className="py-12 lg:py-24 bg-white overflow-hidden">
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <button type="button" aria-label="Previous PET Technology" suppressHydrationWarning className="projects-prev absolute left-0 md:-left-6 top-1/2 -translate-y-1/2 z-20 w-12 h-12 bg-white rounded-full flex items-center justify-center text-dark shadow-xl border border-gray-100 hover:bg-seppa-red hover:text-white transition duration-300 opacity-0 group-hover:opacity-100 disabled:opacity-0 hidden md:flex">
                    ...
                    <button type="button" aria-label="Next PET Technology" suppressHydrationWarning className="projects-next absolute right-0 md:-right-6 top-1/2 -translate-y-1/2 z-20 w-12 h-12 bg-white rounded-full flex items-center justify-center text-dark shadow-xl border border-gray-100 hover:bg-seppa-red hover:text-white transition duration-300 opacity-0 group-hover:opacity-100 disabled:opacity-0 hidden md:flex">
