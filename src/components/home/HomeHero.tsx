...
const HomeHero = () => {
  return (
    ...
    {/* Background Video */}
      <div className="absolute inset-0 z-0 bg-dark m-3 rounded-2xl overflow-hidden">
  <video
    autoPlay
    loop
    muted
 ...
 <div className="absolute inset-0 bg-gradient-to-r from-dark/90 to-dark/10"></div>
  ...
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {[15, 35, 55, 75, 95].map((pos, idx) => (
      ...
      <div className="container mx-auto px-4 left-30 relative z-10 h-full flex items-center">
        <motion.div
          initial="hidden"
          animate="visible"
      ...
      {/* Bottom Checklists */}
     <div className="absolute bottom-0 left-0 w-full to-transparent pt-16 pb-8 z-10">
