      ...
      <div className="container mx-auto px-4">
        ...
        >
          <motion.div variants={fadeInUp} className="inline-flex items-center justify-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-[2rem] border border-gray-200 bg-white mb-6 max-w-[95%] mx-auto">
            ...
            <span className="text-[11px] sm:text-sm font-medium text-dark uppercase tracking-wider text-center sm:text-left leading-tight">
              {getT('tag')}
            </span>
          </motion.div>
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="w-full lg:w-1/4 bg-white rounded-[2rem] p-8 shadow-sm h-full min-h-[350px] flex flex-col justify-between">
            ...
            <div>
              <h3 className="text-2xl font-bold font-heading text-dark mb-4">{getT('expertiseTitle')}</h3>
          ...
          <motion.div variants={fadeInUp} className="w-full lg:w-1/4 bg-white rounded-[2rem] p-8 shadow-sm h-full min-h-[350px] flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-end gap-2 mb-4">
                ...
                <span className="text-gray-500 font-medium pb-1">{getT('projectsLabel')}</span>
              </div>
            ...
            <div className="flex items-center gap-2 group cursor-pointer w-full">
              <Link href={isArabic ? "/about-us" : "/about-us"} className="flex-1 bg-[#101934] text-white px-6 py-[14px] rounded-full font-medium transition duration-300 group-hover:bg-seppa-red text-center text-sm md:text-base">
                {getT('learnMore')}
              </Link>
              <Link href={isArabic ? "/about-us" : "/about-us"} className="w-[50px] h-[50px] shrink-0 bg-seppa-red flex items-center justify-center text-white rounded-full group-hover:bg-[#101934] transition duration-300 shadow-md">
