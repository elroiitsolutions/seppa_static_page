    ...
    <section className="py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          {/* Center: Large Video Thumbnail */}
          <motion.div variants={fadeInUp} className="w-full lg:w-2/4 relative rounded-[2rem] overflow-hidden group cursor-pointer aspect-video shadow-lg">
            <img 
              src="https://demo.awaikenthemes.com/yarnex/wp-content/uploads/2026/02/about-video-bg.jpg" 
              alt="Factory machinery" 
              className="w-full h-full object-cover group-hover:scale-105 transition duration-700"
            />
            <div className="absolute inset-0 bg-dark/20 group-hover:bg-dark/30 transition duration-300"></div>
            {/* Shiny Glass Effect */}
            <div className="absolute top-0 left-[-100%] w-[50%] h-full bg-gradient-to-r from-transparent via-white/40 to-transparent skew-x-[-25deg] group-hover:left-[200%] transition-all duration-1000 ease-in-out z-10 pointer-events-none"></div>
            <div className="absolute inset-0 flex items-center justify-center z-20">
              <div className="w-20 h-20 rounded-full bg-white/90 text-white flex items-center justify-center text-2xl group-hover:bg-[seppa-red] group-hover:scale-110 transition duration-300 shadow-xl backdrop-blur-sm">
